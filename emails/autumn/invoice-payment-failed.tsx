...
interface InvoicePaymentFailedEmailProps {
  ...
  amount?: string;
  currency?: string;
  retryDate?: string; // e.g., "Nov 20, 2025"
...
export const InvoicePaymentFailedEmail = ({
  ...
  amount = '49.00',
  currency = 'USD',
  retryDate = 'Nov 20, 2025',
  updatePaymentUrl = 'https://useautumn.com/billing/payment-method',
  ...
  const previewText = `Your payment failed — update your card`;
            ...
            >
              <Section className="p-[16px]">
                ...
                <Text className="mt-0 mb-[12px] text-[13px] leading-[1.6]" style={{ color: ds.colors.text.tertiary }}>
                  Hi {firstName}, we couldn’t process your payment of{' '}
                  <span className="font-semibold" style={{ color: ds.colors.text.secondary }}>
                    {amount} {currency}
                  </span>
                  . We’ll retry on {retryDate}. Please update your payment method to avoid interruption.
                </Text>

                <Section className="mt-[16px] mb-[8px]">
                  <AutumnEmailButton href={updatePaymentUrl} variant="destructive" paddingVertical="8px" paddingHorizontal="14px">
                    Update payment method
                  </AutumnEmailButton>
                </Section>

                <Text className="mt-[4px] mb-0 text-[12px]" style={{ color: ds.typography.tiny.color }}>
                  Or manage billing in your{' '}
...
InvoicePaymentFailedEmail.PreviewProps = {
  firstName: 'Ava',
  amount: '49.00',
  currency: 'USD',
  retryDate: 'Nov 20, 2025',
  ...
  productName: 'Autumn',
  companyAddress: 'Autumn Inc., San Francisco & London',
} as InvoicePaymentFailedEmailProps;
