...
interface BetterAuthMagicLinkProps {
  magicLink?: string;
  userEmail?: string;
  appName?: string;
...
export const BetterAuthMagicLink = ({
            ...
            >
              <Section className="p-[32px]">
                ...
                <Text className="mt-[12px] mb-[16px] text-[12px] leading-[1.5]" style={{ color: ds.colors.text.tertiary }}>
                  If you didn't request this email, you can safely ignore it. Someone else might have typed your email
                  address by mistake.
                </Text>
...
BetterAuthMagicLink.PreviewProps = {
  magicLink: 'https://app.slackbound.com/auth/verify?token=abc123def456',
  userEmail: 'ryan@mandarin3d.com',
  appName: 'slackbound',
  expirationMinutes: 15,
} as BetterAuthMagicLinkProps;

export default BetterAuthMagicLink;
